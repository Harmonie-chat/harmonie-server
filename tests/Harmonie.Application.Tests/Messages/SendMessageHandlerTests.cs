...
public sealed class SendMessageHandlerTests
{
    ...
    public async Task HandleAsync_WhenChannelDoesNotExist_ShouldReturnNotFound()
    {
        ...
        var response = await _handler.HandleAsync(new SendChannelMessageInput(channelId, request), userId);
    ...
    public async Task HandleAsync_WhenChannelIsVoice_ShouldReturnNotText()
    {
        ...
        var response = await _handler.HandleAsync(new SendChannelMessageInput(channel.Id, request), userId);
    ...
    public async Task HandleAsync_WithEmptyContent_ShouldReturnMessageContentEmpty()
    {
        var response = await _handler.HandleAsync(
            new SendChannelMessageInput(GuildChannelId.New(), new SendMessageRequest("   ")),
            UserId.New());
    ...
    public async Task HandleAsync_WithOwnedAttachmentFiles_ShouldPersistAttachmentsAndReturnThem()
    {
        ...
        var response = await _handler.HandleAsync(
            new SendChannelMessageInput(channel.Id, new SendMessageRequest("message with file", [attachment.Id.ToString()])),
            userId);
    ...
    public async Task HandleAsync_WhenRequestTokenCanceledAfterCommit_ShouldNotifyWithIndependentToken()
    {
        ...
        var response = await _handler.HandleAsync(new SendChannelMessageInput(channel.Id, request), userId, requestCts.Token);
