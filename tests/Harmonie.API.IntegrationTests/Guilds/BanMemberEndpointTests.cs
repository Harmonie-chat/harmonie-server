...
public sealed class BanMemberEndpointTests : IClassFixture<HarmonieWebApplicationFactory>
{
    private readonly HttpClient _client;

    public BanMemberEndpointTests(HarmonieWebApplicationFactory factory)
    {
