...
public sealed class ListBansEndpointTests : IClassFixture<HarmonieWebApplicationFactory>
{
    private readonly HttpClient _client;

    public ListBansEndpointTests(HarmonieWebApplicationFactory factory)
    {
