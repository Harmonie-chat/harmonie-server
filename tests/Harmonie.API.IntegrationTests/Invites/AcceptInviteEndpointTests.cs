...
public sealed class AcceptInviteEndpointTests : IClassFixture<HarmonieWebApplicationFactory>
{
    private readonly HttpClient _client;

    public AcceptInviteEndpointTests(HarmonieWebApplicationFactory factory)
    {
